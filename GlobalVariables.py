...
#     kbar_icon_path = f'{Path.home()}/Development/after-effects/scripts/icons/KBar_Icons.ai'
#     script_directory = f'{Path.home()}/Development/after-effects/scripts'
...
class PopularProjectFolders:
    file_inbox = f'{Path.home()}/Desktop/file_inbox'
